...
# To use PostgreSQL, install psycopg2-binary and uncomment the PostgreSQL config below.
DATABASES = {
    'default': {
...
# PostgreSQL configuration (uncomment when psycopg2-binary is installed)
# DATABASES = {
#     'default': {
